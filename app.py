...
class Orion:
    ...
    def delete_users(self, user):
        try:
            ...
            resp = self.user_management_client.delete_user(token=self.admin_access_token,
                                                username=user['username'])
    ...
    # def allocate_users_to_groups(self, user_map):
    #     try:
    #         group_id = self.created_groups[user_map['group_name']]
    #         # print("This is the group_id: ", group_id)
    #         print("Assigning user " + user_map['username'] + " to group " + user_map['group_name'])
...
def register_handler():
    try:  
        ...
        print("This reaches here", request.json)
...
# @app.route("/userstogroup",methods = ['POST'])
# def users_to_group_handler():
#     try:  
#         print("This is the request that comes in", str(request.json))
#         return orion.allocate_users_to_groups(request.json)
#     except Exception as e:
#         print(e)
